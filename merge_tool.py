...
#@ String (label="Thershold1") thershold1
#@ File (label="Input directory 2", style="directory") inputdirec2
#@ String (label="Thershold2") thershold2
...
def direc_merge(direc1, direc2, thresh1=None, thresh2=None):
	...
	for path1 in paths1:
		...
		if path2:
			...
			merged, alt_1, alt_2, imp1, imp2 = merge(img1, img2, thresh1, thresh2)
...
thresh1 = float(thershold1)
thresh2 = float(thershold2)
...
direc_merge(copy_path1, copy_path2, thresh1, thresh2)	
